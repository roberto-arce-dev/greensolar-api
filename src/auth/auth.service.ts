...
import { InstaladorProfileService } from '../instalador-profile/instalador-profile.service';
...
export class AuthService implements OnModuleInit {
  constructor(
    ...
    private instaladorProfileService: InstaladorProfileService,
  ) {}
    ...
    try {
      ...
      case Role.CLIENTE:
        await this.clienteProfileService.create(userId, {
          ...
          tipoCliente: registerDto.tipoCliente,
        });
        break;
      case Role.INSTALADOR:
        await this.instaladorProfileService.create(userId, {
